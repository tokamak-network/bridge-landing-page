          ...
          <Flex flexDir={"column"} rowGap={"42px"}>
            ...
            >
              ...
              <Text
                ...
                lineHeight={"20px"}
              >
                The latest advancements are designed to optimise profits for
                traders and liquidity providers, reduce price slippage, and
                effectively handle potential risks.
              </Text>
